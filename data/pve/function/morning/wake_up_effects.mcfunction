...
# Apply effect
execute as @a[tag=pve.woke_up] store result score @s pve.morning.wake_up_effect run random value 0..3
...
# Reset data
scoreboard players reset @a pve.morning.wake_up_effect
