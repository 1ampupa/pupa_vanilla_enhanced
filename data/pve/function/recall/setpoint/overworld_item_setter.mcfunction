...
execute as @e[type=item,nbt={Item:{id:"minecraft:stick",components:{"minecraft:custom_data":{"pve.recall_point_setter":{"Dimension":"minecraft:overworld"}}}},OnGround:1b}] \
 at @s if dimension minecraft:overworld run tag @s add pve.recall_setter_correct

# Check for item in wrong dimensions
execute as @e[type=item,nbt={Item:{id:"minecraft:stick",components:{"minecraft:custom_data":{"pve.recall_point_setter":{"Dimension":"minecraft:overworld"}}}},OnGround:1b}] \
 at @s unless dimension minecraft:overworld run tag @s add pve.recall_setter_incorrect
