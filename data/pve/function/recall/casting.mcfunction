...
function pve:recall/check/check_distance
...
execute as @a[tag=pve.recalling] run effect give @s minecraft:resistance 6 4 true
execute as @a[tag=pve.recalling] run effect give @s minecraft:slowness 5 255 true
...
execute as @a[tag=pve.recalling] run effect give @s minecraft:levitation 5 0 true
